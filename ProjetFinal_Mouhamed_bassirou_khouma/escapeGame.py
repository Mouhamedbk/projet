...
def check_exit(grid):
    ...
    if player_position == (26, 17):
        messagebox.showinfo("Félicitations", "Vous êtes sorti du château avec succès!")
        exit()
        # answer = messagebox.askquestion("Félicitations", "Voulez-vous quitter le jeu?")
        # if answer == "yes":
        #     turtle.bye()
        # else:
